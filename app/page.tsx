...
import { ArrowRight, TrendingUp, Shield, Zap, Star, CheckCircle, Sparkles } from "lucide-react"
      ...
      <main className="container mx-auto px-6 py-20">
        <div className="max-w-5xl mx-auto text-center mb-16">
          <div className="inline-flex items-center gap-2 glass px-4 py-2 rounded-full border mb-6 animate-slide-in-up">
            ...
            <span className="text-sm font-medium">Más de 50,000 usuarios confían en nosotros</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16 animate-slide-in-up">
            ...
            <Link
              href="/login"
              className="glass border px-8 py-4 rounded-xl font-semibold hover:border-primary/50 transition-all btn-press"
            >
              Ver Demo
            </Link>
          </div>
        ...
        <section className="py-20">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">¿Por qué MoneyFlow?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="glass rounded-2xl p-8 border card-hover">
              ...
              <h3 className="text-xl font-bold mb-4">Análisis en Tiempo Real</h3>
            ...
            <div className="glass rounded-2xl p-8 border card-hover">
              ...
              <h3 className="text-xl font-bold mb-4">Seguridad Máxima</h3>
              <p className="text-muted-foreground mb-6">
            ...
            <div className="glass rounded-2xl p-8 border card-hover">
              ...
              <h3 className="text-xl font-bold mb-4">Reportes Avanzados</h3>
              <p className="text-muted-foreground mb-6">
        ...
        <section className="py-20">
          <div className="glass rounded-3xl p-12 border text-center max-w-4xl mx-auto card-hover">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Únete a miles de personas que ya mejoraron su salud financiera con MoneyFlow
            </p>
            <Link
              href="/register"
      ...
      <footer className="glass border-t mt-20">
        <div className="container mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="text-sm text-muted-foreground">© 2026 MoneyFlow. Todos los derechos reservados.</div>
          </div>
        </div>
      </footer>
    </div>
